      ...
      <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 mt-3">
        ...
        <b-form v-if="show" @reset.prevent="onReset()" @submit.prevent="onSubmit()">
          ...
          <b-form-group id="input-group-email" label="Email:" label-for="input-email">
            ...
            ></b-form-input>
            <b-form-invalid-feedback id="input-email-feedback">{{error.email.message}}</b-form-invalid-feedback>
          </b-form-group>
          ...
          <b-form-group id="input-group-password" label="Senha:" label-for="input-password">
            <b-form-input
              ...
              placeholder="Informe no mínimo 6 caracteres alfanuméricos"
            ></b-form-input>
            <b-form-invalid-feedback id="input-password-feedback">{{error.password.message}}</b-form-invalid-feedback>
          </b-form-group>
    ...
    async onSubmit() {
        try {
            ...
            if(this.form.passwordConfirmation !== this.form.password) {
                ...
                this.error.password.message = "Os valores informados nos campos de senha devem ser iguais."
                return;
            }
